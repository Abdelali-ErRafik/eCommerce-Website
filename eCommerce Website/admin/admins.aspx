<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="admins.aspx.cs" Inherits="eCommerce_Website.admin.admins" %>
      ...
      <asp:Repeater  ID="rptAdmins" runat="server" OnItemCommand="rptAdmins_ItemCommand" >
            ...
            <ItemTemplate>
                    <tr>
                      ...
                      <td>
                          <a class="text-success" href="editadmin.aspx?uid=<%# Eval("UID") %>"><i class="fa-solid fa-pen"></i> Edit</a>  
                      </td>                      
                       <td>
        ...
        <div class="d-grid gap-2 col-sm-2  mb-4">
            <asp:HyperLink ID="lnkAddAdmin" class="btn btn-primary text-light btn-block gradient-custom-2 shadow" runat="server" NavigateUrl="~/admin/addadmin.aspx">Add Admin</asp:HyperLink>
    </div>
