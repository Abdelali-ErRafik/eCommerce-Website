<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="editsize.aspx.cs" Inherits="eCommerce_Website.admin.editsize" %>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <h2 class="text-center mt-4">Edit Size</h2>
      <section>
                    ...
                    <div class="card-body">
                         <div class="row g-2 align-items-cente justify-content-start mb-2">   
                            <div class="col-md-2  text-lg-end">
                                <asp:Label class="form-label" ID="lblSizeID" runat="server" >Size ID</asp:Label>
                            </div>                             
                            <div class="col-md-8">
                                <asp:TextBox ID="txtSizeID" class="form-control " runat="server" OnTextChanged="txtSizeID_TextChanged"  AutoPostBack="true"></asp:TextBox>
                            </div>                    
                            <div class="col-lg-2">
                                <asp:RequiredFieldValidator ID="RequiredFieldValidatorSizeID" runat="server" ErrorMessage="Please Enter Size ID" ControlToValidate="txtSizeID" ForeColor="Red"></asp:RequiredFieldValidator>
                            </div>
                        </div> 
                        ...
                        <div class="row g-2 align-items-cente justify-content-start">   
                            ...
                            <div class="col-md-10">
                                <asp:Button ID="btnUpdateSize" CssClass="btn btn-primary gradient-custom-2" runat="server" Text="Update Size" OnClick="btnUpdateSize_Click"  />
                            </div>
                        </div>
