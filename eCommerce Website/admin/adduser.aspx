<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="adduser.aspx.cs" Inherits="eCommerce_Website.admin.adduser" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <h2 class="text-center mt-4">Add User</h2>
      <section>
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-2 align-items-cente justify-content-start ">   
                            ...
                            <div class="col-md-10">
                                <asp:Button ID="BtnAddUser" class="btn btn-primary gradient-custom-2" runat="server" Text="Add User" OnClick="BtnAddUser_Click"   />
                            </div>
                        </div>
                    </div>
                </div>
