...
namespace eCommerce_Website.admin
{
    public partial class admins : System.Web.UI.Page
    {
        ...
        private void BindAdminsReapater()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("select * from Users where UserType = 'admin'", cnx);
        ...
        protected void rptAdmins_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            if (confirmValue == "Yes")
            {
                if (e.CommandName == "Remove")
                {
                    ...
                    {
                        SqlCommand cmd = new SqlCommand("delete from Users where UID = @UID and UserType = 'admin'", con);
