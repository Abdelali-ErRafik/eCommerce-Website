<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="addadmin.aspx.cs" Inherits="eCommerce_Website.admin.addadmin" %>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-2 align-items-cente justify-content-start ">   
                            ...
                            <div class="col-md-10">
                                <asp:Button ID="BtnAddAdmin" class="btn btn-primary gradient-custom-2" runat="server" Text="Add Admin" OnClick="BtnAddAdmin_Click"   />
                            </div>
                        </div>
                    </div>
                </div>
