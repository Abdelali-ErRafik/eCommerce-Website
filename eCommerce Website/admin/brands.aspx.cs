...
namespace eCommerce_Website.admin
{
    public partial class brand : System.Web.UI.Page
    {
        ...
        private void BindBrandReapater()
        {
        ...
        protected void rptBrands_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            if (confirmValue == "Yes")
            {
                if (e.CommandName == "Remove")
                {
                    ...
                    {
                        SqlCommand cmd = new SqlCommand("delete from brands where BrandID  = @BrandID ", con);
        ...
        protected void LnkSearch_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string qr = "select * from brands where BrandName like '%" + txtFilter.Text + "%' order by BrandName asc";
