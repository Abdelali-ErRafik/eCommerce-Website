<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="editproduct.aspx.cs" Inherits="eCommerce_Website.admin.editproduct" %>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                 ...
                 <div class="row g-2 align-items-cente justify-content-start mb-2">   
                    <div class="col-md-2 ">
                        <asp:Label class="form-label" ID="lblProductID" runat="server" >Product ID</asp:Label>
                    </div>                             
                    <div class="col-md-8">
                        <asp:TextBox ID="txtProductID" class="form-control " runat="server" AutoPostBack="true" OnTextChanged="txtProductID_TextChanged" ></asp:TextBox>
                    </div>                            
                    <div class="col-md-2 ">
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please enter product Id" ControlToValidate="txtProductID" ForeColor="Red"></asp:RequiredFieldValidator>
                    </div>
                </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row g-2 align-items-cente justify-content-start">   
                        ...
                        <div class="col-md-10">
                             <asp:Button ID="btnUpdatePoduct" CssClass="btn btn-primary gradient-custom-2" runat="server" Text="Update Product" OnClick="btnUpdatePoduct_Click"    />
                        </div>
                    </div>
                </div>
            </div>
