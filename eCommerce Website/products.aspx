<%@ Page Title="" Language="C#" MasterPageFile="~/user.Master" AutoEventWireup="true" CodeBehind="products.aspx.cs" Inherits="eCommerce_Website.products" %>
		...
		<section>
             <div class="container">
                <div class="d-flex justify-content-center my-4">
                         <h3 class="text-center mt-2 mx-1">Products</h3>
                            <div class="searchbar">
                                ...
                                <div class="col-lg-3 col-sm-6 d-flex flex-column align-items-center justify-content-center product-item my-3">
                                    <a href="productview.aspx?pid=<%# Eval("PID") %>">
                                        ...
                                        <div class="price text-center">
                                            <del class="text-danger "><%# decimal.Parse(Eval("PPrice").ToString()).ToString("G29") %>Dh</del> <%# decimal.Parse(Eval("PSelPrice").ToString()).ToString("G29") %>Dh
                                        </div>
                                    </a>
                                </div>
                             <%--  --%>
