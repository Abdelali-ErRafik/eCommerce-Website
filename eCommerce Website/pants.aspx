<%@ Page Title="" Language="C#" MasterPageFile="~/user.Master" AutoEventWireup="true" CodeBehind="pants.aspx.cs" Inherits="eCommerce_Website.pants" %>
                                ...
                                <div class="col-lg-3 col-sm-6 d-flex flex-column align-items-center justify-content-center product-item my-3">
                                    <a href="productview.aspx?pid=<%# Eval("PID") %>">
                                        ...
                                        <div class="price text-center">
                                            <del class="text-danger ">$<%# decimal.Parse(Eval("PPrice").ToString()).ToString("G29") %></del>$<%# decimal.Parse(Eval("PSelPrice").ToString()).ToString("G29") %></div>
                                    </a>
                                </div>
                             <%--  --%>
